...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Frequently Asked Question(s)</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <tbody>
                                      <?php foreach ($faq as $key => $value) { ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="/backoffice/delete/faq/<?php echo $value['id'] ?>" title="Delete" class="btn btn-default delete">Delete</a></td>
                                        </tr>
                                      <?php } ?>
                                    </tbody>
                                </table>
          ...
          <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
             <form action="/backoffice/addFaq" method="post">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel">Add a New FAQ</h4>
                                        </div>
...
<script>
   $(document).on('click','.delete',function(event){
    if (!confirm("Sure to delete this Question/Answer?")) {
