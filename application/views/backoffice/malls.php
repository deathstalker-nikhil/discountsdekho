...
?>
        ...
        <div id="page-wrapper">
                                    ...
                                    <tbody>
                                      <?php foreach ($malls as $key => $value) { ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="/backoffice/delete/malls/<?php echo $value['id'] ?>" title="Delete" class="btn btn-default delete">Delete</a></td>
                                        </tr>
                                      <?php } ?>
                                    </tbody>
                                </table>
          ...
          <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <form action="/backoffice/addMall" method="post">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel">Add a New Mall</h4>
                                        </div>
...
<script>
   $(document).on('click','.delete',function(event){
    if (!confirm("Sure to delete this mall?")) {
