...
--
-- Host: localhost
-- Generation Time: Sep 30, 2015 at 12:30 PM
...
INSERT INTO `deals` (`id`, `title`, `brand`, `brand_details`, `category`, `subcategory`, `city`, `details`, `region`, `locations`, `malls`, `start_date`, `end_date`, `images`, `active`, `authorized`, `merchant_id`) VALUES
(1, 'Test Deal', 'Test Brand', '<p>asdasda</p>', 'Apparels', '["Men Wear"]', '["Ghaziabad","Faridabad"]', '<p>hkjhkjhkjhkjhkjhkjhjkhjko</p>', 'Delhi NCR', 'asdasda', '""', '2015-09-01', '0000-00-00', '{"Image1":"","Image2":"","Image3":"","Image4":"","Image5":""}', 1, 0, 0),
(2, 'teska', 'amsdaksmdk', '<p>askmdkasmdkmaskd</p>', 'Beauty and Grooming', '["Salon","Tattoo"]', '["Pune"]', '<p>sd jaskdka</p>', 'Pune', 'askdmkmk', '["DLF Promenade Mall - Vasant Kunj ,  3 Nelson Mandela Road, Delhi,  Ph ","D Mall, Rohini, Delhi, Ph:011 4390 0000"]', '2015-12-31', '0000-00-00', '{"Image1":"","Image2":"","Image3":"","Image4":"","Image5":""}', 1, 0, 0),
(3, 's axmas', 'ksasmdk', '<p>kasmkm</p>', 'Fitness and Sports', '["Gym"]', '["Noida"]', '<p>kaksmd</p>', 'Delhi NCR', 'asmdla', '""', '2015-01-01', '0000-00-00', '{"Image1":"","Image2":"","Image3":"","Image4":"","Image5":""}', 1, 0, 0),
(4, 'ldsf', 'tester', '<p>admlas, hola hola hua hua hua hu admlas, hola hola hua hua hua hua admlas, hola hola hua hua hua hua admlas, hola hola hua hua hua hua admlas, hola hola hua hua hua huaadmlas, hola hola hua hua hua hua admlas, hola hola hua hua hua huaadmlas, hola hola hua hua hua huaadmlas, hola hola hua hua hua huaadmlas, hola hola hua hua hua huaa</p>', 'Apparels', '["Men Wear"]', '["Noida","Greater Noida"]', '<p>adsmams</p>', 'Delhi NCR', 'ksm', '["Mall of India, Noida, Ph: +919560214267","Pacific Mall, Subhash Nagar, Delhi, Ph:+(91)-11-40903000"]', '2015-01-09', '0000-00-00', '{"Image1":"","Image2":"","Image3":"","Image4":"","Image5":""}', 1, 0, 0),
(5, 'yfac', 'nibble', '<p>lf</p>', 'Beauty and Grooming', '["Spa","Nail Art"]', '["Noida","Greater Noida"]', '<p>bas kya bataye</p>', 'Delhi NCR', 'bahut#hole#hole#hole#hua#panga', '["Select City Walk Mall \\u2013 Saket ,  A-3m District Centre Saket, Sector 6,","Ambience Mall - Vasant Kunj ,  No. 2, Nelson Mandela Marg , Delhi, Ph ","Pacific Mall, Subhash Nagar, Delhi, Ph:+(91)-11-40903000"]', '2015-09-22', '0000-00-00', '{"Image1":"","Image2":"","Image3":"","Image4":"","Image5":""}', 1, 0, 0),
(6, 'nacho', 'gao', '<p>nacho gao</p>', 'Miscellaneous', '["Dance Classes"]', '["New Delhi"]', '<p>nacho gao jor se</p>', 'Delhi NCR', 'bahut#bahut#bahut#bahut#bahut#bahut#bahut#bahut#bahut#bahut#bahut#bahut#bahut#bahut', '["Mall Eighteen, Sector 18, Noida, Ph:+91-22-26058753","Select City Walk Mall \\u2013 Saket ,  A-3m District Centre Saket, Sector 6,","DLF Promenade Mall - Vasant Kunj ,  3 Nelson Mandela Road, Delhi,  Ph "]', '2015-09-16', '2015-09-30', '{"Image1":"","Image2":"","Image3":"","Image4":"","Image5":""}', 1, 0, 0),
(7, 'tesasnd', 'brand', '<p>brand_details</p>', 'Apparels', '["Men Wear"]', '["New Delhi","Greater Noida"]', '<p>deal_details</p>', 'Delhi NCR', 'deal locations#deal locations#deal locations', '["The Centre Stage Mall \\u2013 Noida , Pocket J, Sector 18, Ph : 0120- 425144"]', '2015-09-02', '0000-00-00', '{"Image1":"\\/assets\\/uploads\\/lion-wallpaper-hd-1080p-black-and-white.jpg","Image2":"","Image3":"","Image4":"","Image5":""}', 1, 0, 0);
...
(1, 'Delhi NCR', '["North Delhi","South Delhi","East Delhi","West Delhi","Noida","Greater Noida","Ghaziabad","Gurgaon"]'),
(4, 'Pune', '["Pune"]');
...
ALTER TABLE `merchant`
 ADD PRIMARY KEY (`merchant_id`), ADD UNIQUE KEY `email` (`email`);
...
--
ALTER TABLE `merchant`
MODIFY `merchant_id` int(3) NOT NULL AUTO_INCREMENT;
--
